...
const FeaturedPosts = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto mt-1 px-2 sm:px-4 lg:px-6 h-[91vh] overflow-y-auto">
        ...
        {posts.slice(0, 3).map((post, index) => (
          ...
          >
            ...
            {post.img && (
              <Link
                to={`/posts/${post.slug}`}
                className="w-full sm:w-48 md:w-56 lg:w-64 xl:w-72 h-48 sm:h-32 md:h-36 lg:h-40 xl:h-44 flex-shrink-0"
              >
                <Image src={post.img} className="w-full h-full object-cover" />
              </Link>
            )}
            ...
            <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex-1 flex flex-col justify-between min-h-0">
              <div className="flex-1">
                ...
                <Link to={`/posts/${post.slug}`}>
                  <h3 className="text-base sm:text-lg lg:text-xl dark:text-white dark:bg-black font-semibold text-gray-900 mb-2 line-clamp-2 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    {post.title}
                  </h3>
                </Link>
              ...
              <div className="text-xs sm:text-sm dark:text-white dark:bg-black text-gray-700 mt-auto">
                Written By{" "}
